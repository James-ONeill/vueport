(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vueport"] = factory();
	else
		root["vueport"] = factory();
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/vue-loader/lib??vue-loader-options!./src/components/VueportPageScroll.vue?vue&type=script&lang=js

/* harmony default export */ var VueportPageScrollvue_type_script_lang_js = ({
  data: function data() {
    return {
  ...
  created: function created() {
    ...
    this.$once("hook:beforeDestroy", function () {
      window.removeEventListener("scroll", _this.recalculateScroll);
      window.removeEventListener("resize", _this.recalculateScroll);
    });
  },
  computed: {
    scrollableHeight: function scrollableHeight() {
      return this.scrollHeight - this.clientHeight;
    },
    scrollPcnt: function scrollPcnt() {
      return this.scrollY / this.scrollableHeight * 100;
    }
  },
  methods: {
    recalculateScroll: function recalculateScroll() {
      var _this2 = this;
      ...
      requestAnimationFrame(function () {
        ...
        _this2.scrollHeight = document.documentElement.scrollHeight;
        _this2.clientHeight = document.documentElement.clientHeight;
...
// CONCATENATED MODULE: ./src/components/VueportPageScroll.vue?vue&type=script&lang=js
 /* harmony default export */ var components_VueportPageScrollvue_type_script_lang_js = (VueportPageScrollvue_type_script_lang_js); 
...
// CONCATENATED MODULE: ./src/components/VueportPageScroll.vue
...
var component = normalizeComponent(
  components_VueportPageScrollvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var VueportPageScroll = (component.exports);
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/vue-loader/lib??vue-loader-options!./src/components/VueportElementPosition.vue?vue&type=script&lang=js
/* harmony default export */ var VueportElementPositionvue_type_script_lang_js = ({
  data: function data() {
    return {
  ...
  mounted: function mounted() {
    ...
    this.$once("hook:beforeDestroy", function () {
      window.removeEventListener("scroll", _this.updateBoundingRect);
      window.removeEventListener("resize", _this.updateBoundingRect);
    });
  },
  watch: {
    fullyVisible: function fullyVisible(value) {
  ...
  computed: {
    visible: function visible() {
      ...
      return;
      this.boundingClientRect.bottom > 0 && this.boundingClientRect.top < window.innerHeight;
    },
    fullyVisible: function fullyVisible() {
      if (!this.boundingClientRect) return false;
      return;
      this.boundingClientRect.top > 0 && this.boundingClientRect.bottom < window.innerHeight;
    },
    center: function center() {
      if (!this.boundingClientRect) return;
      var _this$boundingClientR = this.boundingClientRect,
          top = _this$boundingClientR.top,
          height = _this$boundingClientR.height;
      return top + height / 2;
    },
    topPcnt: function topPcnt() {
      if (!this.boundingClientRect) return;
      return this.boundingClientRect.top / window.innerHeight * 100;
    },
    bottomPcnt: function bottomPcnt() {
      if (!this.boundingClientRect) return;
      return this.boundingClientRect.bottom / window.innerHeight * 100;
    },
    centerPcnt: function centerPcnt() {
      if (!this.boundingClientRect) return;
  ...
  methods: {
    updateBoundingRect: function updateBoundingRect() {
      ...
      this.scrolling = true;
      requestAnimationFrame(function () {
        _this2.boundingClientRect = _this2.$el.getBoundingClientRect();
        _this2.scrolling = false;
      });
    }
  },
...
// CONCATENATED MODULE: ./src/components/VueportElementPosition.vue?vue&type=script&lang=js
 /* harmony default export */ var components_VueportElementPositionvue_type_script_lang_js = (VueportElementPositionvue_type_script_lang_js); 
// CONCATENATED MODULE: ./src/components/VueportElementPosition.vue
var VueportElementPosition_render, VueportElementPosition_staticRenderFns
...
var VueportElementPosition_component = normalizeComponent(
  components_VueportElementPositionvue_type_script_lang_js,
  VueportElementPosition_render,
  VueportElementPosition_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var VueportElementPosition = (VueportElementPosition_component.exports);
// CONCATENATED MODULE: ./src/components/index.js


/* harmony default export */ var components = ({
  VueportPageScroll: VueportPageScroll,
  VueportElementPosition: VueportElementPosition
});
...
//# sourceMappingURL=vueport.umd.js.map